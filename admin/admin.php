			...
			<div uk-grid>
				<div class="uk-width-2-3@m">
					<div class="main-buttons">
						...
						<a class="uk-button uk-button-default uk-button-large" href="https://siteronin.com/widgets/" target="_blank">Demo</a>
						<a class="uk-button uk-button-default uk-button-large" href="https://siteronin.com/widgets/docs/" target="_blank">Docs</a>
					</div>
								...
								<div>
									<div class="uk-card uk-card-default">
										...
										<p class="uk-text-center card-btns">
											<a href="https://siteronin.com/widgets/docs/" target="_blank" class="uk-button uk-button-text uk-button-small">See now</a>
										</p>
									</div>
								</div>
								<div>
									<div class="uk-card uk-card-default">
										...
										<p class="uk-text-center">Need help troubleshooting. Get help at the <a href="https://wordpress.org/support/plugin/widgets-for-siteorigin" target="_blank" >WordPress Support Forum</a>. Pro users can email us at <a href="mailto:support@siteronin.com">support@siteronin.com</a>.</p>
										<p class="uk-text-center card-btns">
											...
											<a href="mailto:support@siteronin.com" class="uk-button uk-button-small uk-button-text">Email Support</a>
										</p>
									</div>
								</div>
								<div>
					...
					<div class="uk-child-width-1-1 uk-grid-match uk-grid-small" uk-grid>
						<img class="wpinked-plugin-logo" data-src="<?php echo plugin_dir_url(__FILE__); ?>img/siteronin-logo.png" uk-img style="max-width: 250px;">
					</div>
				</div>
				<div class="uk-width-1-3@m">
					<div class="uk-padding uk-background-secondary uk-light">
						...
						<p class="uk-text-center pro-buttons">
							<a class="license-button uk-button uk-button-default buy-button" href="https://siteronin.com/widgets/" target="_blank">Get it now</a>
						</p>
