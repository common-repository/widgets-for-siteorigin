    ...
    <div class="iw-so-image">
        ...
        <div class="iw-so-caption-wrapper">
            <div class="iw-so-image-caption">
                <figcaption>
                    <?php echo $instance['caption']['title'] ? '<h3 class="iw-so-cap-title">' . esc_html( $instance['caption']['title'] ) . '</h3>' : '' ?>
                    <?php echo $instance['caption']['desc'] ? '<p class="iw-so-cap-desc">' . esc_html( $instance['caption']['desc'] ) . '</p>' : '' ?>
                </figcaption>
            </div>
        </div>
