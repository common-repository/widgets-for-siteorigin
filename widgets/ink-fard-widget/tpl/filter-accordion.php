...
<div class="iw-so-filter-accordion iw-so-accordion<?php echo $expand . $toggle; ?>" id="<?php echo $unique . '-fard-container'; ?>">
	...
	<?php foreach( $instance['toggles'] as $i => $toggle ) { ?>
		...
		<div class="iw-so-acc-item<?php echo ($toggle['active'] == 1 ? ' iw-so-acc-item-active' : '' ); ?> mix <?php echo esc_attr( $toggle['slugs'] ); ?>">
			...
			<a href="#" class="iw-so-acc-title <?php echo esc_attr( $instance['styling']['text'] ); ?>" id="<?php echo $unique . '-' . $acc_no; ?>">
