...
if( $instance['id'] ):
	$unique = esc_attr( $instance['id'] );
else :
	$unique = 'tab-' . ++$wpinked_widget_count;
endif;
?>

<div class="iw-so-tabs iw-so-tabs-<?php echo $instance['styling']['orientation']; ?> iw-so-tabs-<?php echo esc_attr( $instance['styling']['responsive'] ); ?>">
