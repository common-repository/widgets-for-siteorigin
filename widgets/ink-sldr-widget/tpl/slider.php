...
$prev = $instance['settings']['prev-arrow'] ? str_replace(  '"', "'", wpinked_get_so_icon( $instance['settings']['prev-arrow'], $icon_styles ) ) : __( 'Previous', 'wpinked' );
$next = $instance['settings']['next-arrow'] ? str_replace(  '"', "'", wpinked_get_so_icon( $instance['settings']['next-arrow'], $icon_styles ) ) : __( 'Next', 'wpinked' );
...
if( $instance['settings']['autoplay-speed'] != 3000 ) $settings[] = '"autoplaySpeed" :' . esc_attr( $instance['settings']['autoplay-speed'] );
