...
function wpinked_so_testimonial_template( $name, $testimonial, $styling ) {
	...
	if ( in_array( $styling['design'], array( 'by-above', 'by-below', 'boxed-by-above', 'boxed-by-below' ), true ) )  : ?>
		...
		<div class="iw-so-testimonial <?php echo 'iw-so-testimonial-' . esc_attr( $styling['design'] ); ?>">

			<?php if ( $styling['design'] == 'by-above' || $styling['design'] == 'boxed-by-above' ) : ?>
				<div class="iw-so-testimonial-byline iw-so-testi-<?php echo esc_attr( $styling['text'] ); ?>">
			...
			<div class="iw-so-testimonial-content boxed-<?php echo esc_attr( $styling['text'] ) ?>">
				<?php if ( $testimonial['content'] ) : ?>
					<div class="iw-so-testimonial-message <?php echo esc_attr( $testimonial['text'] ); ?>"><?php echo wpinked_so_editor( $testimonial['content'], $testimonial['autop'] ); ?></div>
				<?php endif; ?>
			</div>
	...
	<?php else : ?>
		...
		<div class="iw-so-testimonial <?php echo 'iw-so-testimonial-' . esc_attr( $styling['design'] ); ?>">
			...
			<div class="iw-so-testimonial-content">
				<?php if ( $testimonial['content'] ) : ?>
					<div class="iw-so-testimonial-message <?php echo esc_attr( $testimonial['text'] ); ?>"><?php echo do_shortcode( $testimonial['content'] ); ?></div>
				<?php endif; ?>
...
function wpinked_so_person_template( $name, $person, $social, $styling ) { ?>
	...
	<div class="iw-so-person <?php echo ( $styling['img-width'] == false ? 'iw-so-person-fit' : '' ) ?> iw-so-person-<?php echo esc_attr( $styling['layout'] ); ?>">
